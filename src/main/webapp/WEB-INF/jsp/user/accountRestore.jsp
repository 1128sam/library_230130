<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		<section class="signUp d-flex justify-content-center">
			<div class="sign-up-box">
				...
				<label for="question" class="subject-text my-2 mt-2">
                        ${question}
                </label>
				...
				<div class="d-flex justify-content-end my-2">
					<a href="/user/sign_up_view" id="suggestNewAccount" class="d-none">Create a new account</a><br>
				</div>
			</div>
		</section>
...
$(document).ready(function() {
	$('#confirmBtn').on('click', function(e) {
		...
		let legitAnswer = '<%=(String) session.getAttribute("legitAns")%>';
